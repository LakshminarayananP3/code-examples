...
public class FJRecursion extends RecursiveAction {
    ...
    protected void compute() {
        ...
        invokeAll(new FJRecursion(inputString.substring(0, length / 2)),

                new FJRecursion(inputString.substring(length / 2 - 1, length)));
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        FJRecursion fb = new FJRecursion(stringReadFromFile);
